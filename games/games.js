...
buyBtn?.addEventListener("click", () => {
  ...
  if (whatsappInput && !whatsappInput.value.trim()) missingFields.push("WhatsApp Number");
  ...
  const whatsapp = encodeURIComponent(whatsappInput?.value.trim() || "");
  ...
  if (whatsappInput) url += `&whatsapp=${whatsapp}`;
